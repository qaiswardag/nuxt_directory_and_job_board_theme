<script setup>
import ArticleTemplate from '../layouts/ArticleTemplate.vue';
import WidgetSectionBorder from '../sections/WidgetSectionBorder.vue';
import UserTag from '../users/UserTag.vue';
      ...
      <aside class="flex gap-8 flex-col">
        ...
        <template v-if="onlyForCurrentTeam">
          ...
          >
            ...
            <WidgetSectionBorder></WidgetSectionBorder>
            <div class="myPrimaryTag bg-myPrimaryLinkColor text-white">
              Published
            </div>
          </div>
          <div
          ...
          >
            <h4 class="myQuaternaryHeader">Published</h4>
            <WidgetSectionBorder></WidgetSectionBorder>
            <div class="myPrimaryTag bg-myPrimaryErrorColor text-white">
              Unpublished
            </div>
          </div>
        </template>
        ...
        <template v-if="post.apply_via_link || post.apply_via_email">
          <div class="myPrimaryWidget">
            ...
            <div class="flex myPrimaryGap flex-col justify-normal items-start">
              <template v-if="post.apply_via_link">
                <a
                  :href="post.apply_via_link"
                  target="_blank"
                >
                  <button
                    type="button"
        ...
        <!-- countries # start -->
        <div
          v-if="countries && Array.isArray(countries) && countries.length !== 0"
          class="myPrimaryWidget"
        >
        ...
        <!-- states # start -->
        <div
          v-if="states && Array.isArray(states) && states.length !== 0"
          class="myPrimaryWidget"
        >
          ...
          <div class="flex flex-wrap justify-start items-center gap-2">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                <div>
                  <span> {{ state.name }}{{ post.address ? ', ' : '' }} </span>
        ...
        <!-- job types # start -->
        <div
          v-if="jobTypes && Array.isArray(jobTypes) && jobTypes.length !== 0"
          class="myPrimaryWidget"
        >
            ...
            <div class="flex flex-wrap justify-start items-center gap-2">
              <div class="flex flex-wrap justify-start items-center gap-2">
                <p
                  ...
                  post.tags.split(',').sort((a, b) => a.localeCompare(b))"
                  :key="tag"
                  class="text-sm rounded-full bg-myPrimaryLightGrayColor py-1.5 px-2 flex justify-center items-center gap-2"
                >
                  <span class="myMediumIcon material-symbols-outlined">
        ...
        <template v-if="onlyForCurrentTeam && postType !== 'Campaign'">
          ...
          >
            <template v-if="postType === 'Job'">
              <h4 class="myQuaternaryHeader">Show Job Recruiters</h4>
            </template>
            <template v-if="postType === 'Store'">
              <h4 class="myQuaternaryHeader">Show Store Staff Members</h4>
            </template>
            <WidgetSectionBorder></WidgetSectionBorder>
            <div class="myPrimaryTag bg-myPrimaryLinkColor text-white">
              Visible
        ...
        <div
          v-if="
            post.show_author && Array.isArray(authors) && authors.length !== 0
          "
          class="myPrimaryWidget"
        >
          <template v-if="postType === 'Job'">
          ...
          <div class="flex flex-wrap justify-start items-center gap-1">
            ...
            >
              ...
              <span class="flex flex-col items-left gap-1 myPrimaryParagraph">
                <p
